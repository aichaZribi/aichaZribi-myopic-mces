...
def MCES(smiles1, smiles2, threshold=10,threshold_mode='', i=0, solver='default', solver_options={}, no_ilp_threshold=False, always_stronger_bound=False, catch_errors=False):
    """
    ...
    # calculate MCES
    try:
        distance, compute_mode = MCES_ILP(G1, G2, threshold, threshold_mode, solver, solver_options=solver_options,
        ...
        if (catch_errors):
            ...
            raise e
    return i, distance, time.time() - start, compute_mode, ilp_solver
